...
import * as canonicalAgent from '@alvin0/ai-agent-sdk-core/agent'
import * as legacyAgent from '@alvin0/ai-agent-sdk-core/agent'
import { cloneAgent, defineAgent } from '@alvin0/ai-agent-sdk-core/agent'
