...
| `resource` | `RuntimeObservationResourceInput` | `serviceName`, runtime label, etc. |
...
Types: `ToolDefinition`, `ToolRunContext`, `ApprovalBroker`, `ApprovalDecision`,
`ApprovalRequest`, `UserInputAnswer`, `UserInputBroker`, `UserInputDecision`,
